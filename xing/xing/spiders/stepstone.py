...
class StepstoneSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield Request(
            url=f"https://www.stepstone.de/5/ergebnisliste.html?stf=freeText&ns=1&companyid=0&sourceofthesearchfield=resultlistpage%3Ageneral&qs=%5B%5D&cityid=0&ke={self.search_params}&radius=30&suid=713ac238-0c15-4b82-b64b-86fa623b4cef&ex=90001&ob=date&action=sort_publish",
            dont_filter=True,
    ...
    def parse_page(self, response):
        ...
        for item in items:
            ...
            yield {"job_title": title, "job_id": uuid.uuid4(), "link": link}
